...
day: 3
type: "lecture"
topics: "Deploying Deploying a MEN Stack Application to Heroku"
---



# Deploying Deploying a MEN Stack Application to Heroku
...
So, let's make sure we've updated `server.js` in preparation for this.
...
// make sure your "port" variable tries to resolve process.env.PORT first
