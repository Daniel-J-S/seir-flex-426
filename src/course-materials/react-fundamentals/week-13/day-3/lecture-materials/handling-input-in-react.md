...
Let's create a new React Project using `create-react-app` and name it `react-dev-skills`
<br>

Go to your terminal and run the command `npx create-react-app react-dev-skills`
...
Just in case you need a solution to the above project, here it is right here 😎:
